...
namespace Observatory.Photographer
{
    public class PhotoWorker : IObservatoryWorker
    {
        ...
        public PhotoWorker()
        {
            var defaultScreenshotLocation = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures)
                + Path.DirectorySeparatorChar + "Frontier Developments"
                + Path.DirectorySeparatorChar + "Elite Dangerous";
            
            var defaultOutputLocation = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) 
                + Path.DirectorySeparatorChar + "Elite Observatory Screenshots";
        ...
        AboutInfo IObservatoryPlugin.AboutInfo => new()
        {
            AuthorName = "Vithigar",
        ...
        string IObservatoryPlugin.Version => typeof(PhotoWorker).Assembly.GetName().Version?.ToString() ?? "0";
